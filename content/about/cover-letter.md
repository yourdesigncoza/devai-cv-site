---
title: Cover letter
description: "Cover letter from John Montgomery, founder of EdenFintech. Freelance developer available for quant research, LLM / agent, and custom WordPress projects. 22 years in, remote-first."
tags: [about]
draft: false
date: 2026-04-22
---

**John Montgomery** · EdenFintech · Mossel Bay, South Africa
support@edenfintech.com · +27 079 177 1970

---

I've been writing code for money since the early 2000s. The first thing I built was a set of trading "bots" for a trading company, which feels relevant again now: 22 years of programming later, the current work is a screening and AI-review pipeline for US-listed equities, productised as [EdenFintech](https://edenfintech.com/). The long middle of that arc was 20+ years of WordPress, WooCommerce, and custom PHP under the legacy YourDesign name, plus agency sub-contracts including the Woolworths Mother's Day campaign (via Flume) and the Nimue Skin Technology brand build.
...
- Obsidian-to-Quartz knowledge graphs for research topics or case-study work, in the [[projects/signaltrace-site|signaltrace-site]] pattern.
