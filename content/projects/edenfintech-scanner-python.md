...
The pipeline has been used in anger, not just built. There are 22 numbered `batch-*` run directories in the repo, and 9 hydrated sector-knowledge files that accumulate over runs. The public Eden Fintech site is the thin interface on top.
