...
| `/ydcoza-plan status` | n/a | any | Terminal summary |
...
- [[projects/edenfintech-scanner-python|EdenFintech Scanner]], a different kind of staged pipeline, with CLI entry points and provenance tracking at each stage. Same principle, different domain: move the state to disk so upheavals are survivable.
