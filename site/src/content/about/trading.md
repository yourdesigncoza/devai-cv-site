...
[[projects/edenfintech-scanner-python|EdenFintech Scanner (Python)]] sits at the other end of the spectrum (fundamentals on US-listed equities, weekly cadence rather than intraday XAU), but the discipline is the same. Hashed snapshots, contract-tested screens, LLM review behind typed information barriers, a written postmortem when things don't work.
