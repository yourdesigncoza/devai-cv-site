---
title: About
description: "About John Montgomery, founder of EdenFintech. 22 years of software, remote from South Africa. Quant research pipelines and AI / agent systems are the current focus; legacy WordPress work continues under the YourDesign name."
tags: [about]
draft: false
---
...
I'm John Montgomery, founder of **EdenFintech**. I work from Mossel Bay, South Africa. 22 years of programming, 10+ years of those spent in and around trading systems, and a long stretch of WordPress and WooCommerce work in the middle (much of it under the legacy YourDesign name).

## The long arc

I started coding "bots" for a trading company in the early 2000s, before the open-source PHP / MySQL world became the default. By 2004 I was building fully functional CRUD web applications in PHP and MySQL, before WordPress or Drupal had meaningful share. That became freelance work, and the freelance work became [yourdesign.co.za](https://yourdesign.co.za/), which became 20+ years of custom WordPress and WooCommerce builds for small businesses, brand projects, and agency sub-contracts (Nimue Skin Technology, the Woolworths Mother's Day campaign via Flume).

The current work is a loop back to where I started. [[projects/edenfintech-scanner-python|edenfintech-scanner-python]] is a screening and scoring pipeline for US-listed equities, productised through [[projects/edenfintech-com|edenfintech.com]]. It grew out of the earlier AI playground at [[projects/devai-co-za|devai.co.za]] (the InvestAI Analyst Platform, a Natural-Language-to-SQL app, a YouTube summariser) which is where I learned my way around agent toolchains (CrewAI, Fabric, PraisonAI) in 2024.

In parallel, I maintain [[projects/wecoza-development|WeCoza 3.0]] for an education-sector client in South Africa: a WordPress plugin with most of the operational logic in a 43-table Postgres schema. And I run a knowledge-graph practice on the side. [[projects/signaltrace-site|signaltrace-site]] hosts five OSINT / financial-research case studies, and this CV site uses the same pattern.
