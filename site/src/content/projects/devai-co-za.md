...
- **InvestAI Analyst Platform**: a multi-analyst AI stock analysis tool with MA / Bollinger / MACD / RSI / volume charting. The precursor to [[projects/edenfintech-scanner-python|the scanner]].
- **Natural-Language-to-SQL app**: Python + Gradio + OpenAI GPT-3.5-turbo querying a Postgres database from English prompts.
- **YouTube video summariser**: transcript-in, summary-out tool; the lineage that continued into [[projects/yt-ts|yt-ts]].
...
- [[skills/ai-agentic-systems|AI / Agentic Systems]], earliest public LLM work; CrewAI / Fabric / PraisonAI as formative references; custom GPTs as a second surface.
- [[skills/design-brand|Design & Brand]], self-branded playground site, positioning as a developer rather than an agency.

## Decisions worth a deeper read

*Populated as the decision pages land. Likely candidate: why I left devai as a playground and didn't try to consolidate it into the current EdenFintech product.*
