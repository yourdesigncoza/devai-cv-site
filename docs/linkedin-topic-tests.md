...
| 2026-05-06 | Deep-value / distressed quality investing | insider cluster buy | 5 | good | good | ? | **Full-recipe.** 1 strong card: Michael Fox-Rabinovitz (Investment & Risk Executive, CFA/FRM/CAIA) "compass not a map" framing on cluster buys, cites 8-10% one-year outperformance literature, links to insiderflow.io. Comment posted (Variant 2, negative-result receipt). 4 commercial-bait skips: Brian Okoth/Vestara (×2 community-shared promo for insider-tracking SaaS); Satyam Das/NeuralQuant ("7 AI specialists, FREE to use, link in first comment"); Signal8 (insider-intelligence SaaS launch, 61,745 indexed insiders); StockSentinel.ai (Flash AI research video pitch). Second comment-worthy run on this term; track toward graduation (5-run minimum). |
